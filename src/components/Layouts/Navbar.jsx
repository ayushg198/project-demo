  ...
  return (
    <nav className="flex flex-col sm:flex-row items-center sm:justify-between p-4 bg-[#023047] text-white">
      <div className="flex items-center">
        ...
        <Link to="/" className="font-bold text-2xl">Career Compass</Link>
      </div>
      <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 items-center">
        ...
        (
        <>
        <Link to="/login" className="rounded p-4 bg-[#60a5fa] hover:bg-[#2563eb] text-black py-1 px-6 text-lg inline-block">Log in</Link>
        <Link to="/register" className="rounded p-4 bg-[#60a5fa] hover:bg-[#2563eb] text-black py-1 px-6 text-lg inline-block">Sign up</Link>
        </>
        )
      }
      </div>
